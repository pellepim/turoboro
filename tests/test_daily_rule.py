...
class DailyRuleWithEndDateTests(unittest.TestCase):
    def test(self):
        ...
        expected_all_posix = [1388559600, 1388646000, 1388732400, 1388991600, 1389078000, 1389164400, 1389250800,
                              1389337200, 1389596400, 1389682800, 1389769200, 1389855600, 1389942000, 1390201200,
                              1390287600, 1390374000, 1390460400, 1390546800, 1390806000, 1390892400, 1390978800,
                              1391065200, 1391151600]
